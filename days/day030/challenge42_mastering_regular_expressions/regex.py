...
def get_all_hashtags_and_links():
    ...
    tweet = ('New PyBites article: Module of the Week - Requests-cache '
             ...
             '#python #APIs')
    return re.findall(r'(?:http|#)\S+\b', tweet)
...
if __name__ == "__main__":
    ...
    ips = ['1.1.1.1', '255.255.255.255', '192.168.1.1', '10.10.1.1', 
           '132.254.111.10', '26.10.2.10', '127.0.0.1', '10.10.10', 
           '10.10', '10', 'a.a.a.a', '10.0.0.a']
    for ip in ips:
        print(match_ip_v4_address(ip))
